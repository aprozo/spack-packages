...
class Iwyu(CMakePackage):
    ...
    depends_on("llvm+libclang@22", when="@0.26")
    depends_on("llvm+libclang@21", when="@0.25")
    depends_on("llvm+libclang@20", when="@0.24")
    depends_on("llvm+libclang@19", when="@0.23")
    depends_on("llvm+libclang@18", when="@0.22")
    depends_on("llvm+libclang@17.0:17", when="@0.21")
    depends_on("llvm+libclang@16.0:16", when="@0.20")
    depends_on("llvm+libclang@15.0:15", when="@0.19")
    depends_on("llvm+libclang@14.0:14", when="@0.18")
    depends_on("llvm+libclang@13.0:13", when="@0.17")
    depends_on("llvm+libclang@12.0:12", when="@0.16")
    depends_on("llvm+libclang@11.0:11", when="@0.15")
    depends_on("llvm+libclang@10.0:10", when="@0.14")
    depends_on("llvm+libclang@9.0:9", when="@0.13")
    depends_on("llvm+libclang@8.0:8", when="@0.12")
    depends_on("llvm+libclang@7.0:7", when="@0.11")
