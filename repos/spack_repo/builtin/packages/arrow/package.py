...
class Arrow(CMakePackage, CudaPackage):
    ...
    depends_on("llvm@:11 +libclang", when="+gandiva @:3", type="build")
    depends_on("llvm@:12 +libclang", when="+gandiva @:4", type="build")
    depends_on("llvm@:13 +libclang", when="+gandiva @:7", type="build")
    depends_on("llvm@:14 +libclang", when="+gandiva @:9", type="build")
    depends_on("llvm@:15 +libclang", when="+gandiva @:11", type="build")
    depends_on("llvm@:16 +libclang", when="+gandiva @:13", type="build")
    depends_on("llvm@:17 +libclang", when="+gandiva @:15.0.1", type="build")
    depends_on("llvm@:18.1 +libclang", when="+gandiva @:16.0.1", type="build")
    depends_on("llvm@:19.1 +libclang", when="+gandiva", type="build")
